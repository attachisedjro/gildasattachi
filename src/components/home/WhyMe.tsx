...
const differentiators = [
  {
    num: "01",
    title: "Deux marchés.\nUn seul standard.",
    text: "10 ans entre l'Afrique de l'Ouest et le Québec. Les contextes changent, l'exigence de résultats, non.",
    stat: "+50%",
    statLabel: "engagement moyen sur ses mandats",
  },
  {
    num: "02",
    title: "Interne et externe\nsans frontière.",
    text: "Je couvre les deux périmètres sans silo. Ce que je dis à l'externe est cohérent avec ce que vivent les employés.",
    stat: "360°",
    statLabel: "couverture de la communication",
  },
  {
    num: "03",
    title: "Des credentials\nancrés dans la pratique.",
    text: "Membre de l'Ordre des administrateurs agréés du Québec, MBA ESG-UQAM, certifié Change Management Practitioner - Prosci.",
    stat: "3×",
    statLabel: "certifications de haut niveau",
  },
  {
    num: "04",
    title: "La stratégie et\nl'exécution, ensemble.",
    text: "Je construis les plans et je les mets en œuvre. Pas de remise de rapport sans suivi de résultats.",
    stat: "95%",
    statLabel: "fidélisation client SPIRO",
  },
];

function Item({ item, index }: { item: typeof differentiators[0]; index: number }) {
      ...
      <div className="container-custom">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-4">
          ...
          <p className="text-[#81756e] text-sm max-w-xs leading-relaxed">
            Ce qui distingue mon approche de la communication stratégique.
          </p>
        </div>
