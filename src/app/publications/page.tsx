    ...
    <>
      ...
      <section className="pt-40 pb-16 bg-[#26170c]">
        <div className="container-custom">
          ...
          >
            Publications.<br />
            <span className="text-[#e9c176] italic font-light">L'écrit aussi.</span>
          </h1>
          <p className="text-white/50 text-lg mt-8 max-w-md">
            Ce que je pense, je l'écris. Ici, sous forme de livres.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          {livres.length === 0 ? (
            <div className="py-24 text-center">
              <p className="font-display font-bold text-[#d2c4bc] text-2xl">À paraître.</p>
              <p className="text-[#81756e] mt-3 text-sm">Les publications arrivent bientôt.</p>
            </div>
          ) : (
                  ...
                  >
                      ...
                      {imgUrl ? (
                        <div
                          ...
                          style={{
                            aspectRatio: "3/4",
                            borderRadius: "2px",
                            boxShadow: "8px 12px 40px rgba(38,23,12,0.2)",
                          }}
                        >
                          <Image
                            src={imgUrl}
                    ...
                    <div className={`lg:col-span-8 ${isEven ? "lg:order-2" : "lg:order-1"}`}>
                      <div className="flex items-center gap-4 mb-6">
                        {livre.annee && (
                          <span className="font-mono text-[11px] font-bold tracking-[0.2em] text-[#81756e]">
                            {livre.annee}
                          </span>
                        )}
                        {livre.editeur && (
                          <>
                            ...
                            <span className="font-mono text-[11px] font-bold tracking-[0.2em] text-[#81756e] uppercase">
                              {livre.editeur}
                            </span>
                          </>
                        )}
      ...
      <section className="py-20 bg-[#f1edea] border-t border-[#d2c4bc]/30">
        <div className="container-custom flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          ...
          >
            Une question sur mes écrits ?<br />
            <span className="italic font-light text-stroke">Écrivez-moi.</span>
          </h2>
          <Link
            href="/contact"
