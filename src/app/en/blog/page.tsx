...
const PILLARS: Record<string, string> = {
  ...
  employeur:  "Employer Branding",
  interne:    "Internal Communications",
  crise:      "Crisis Communications",
  rp:         "Public Relations",
  numerique:  "Digital Marketing",
...
async function getPosts(): Promise<Post[]> {
  return client.fetch(
    `*[_type == "article" && publie == true && langue == "Anglais"] | order(datePublication desc) {
...
export const metadata = {
  title: "Blog — Gildas Attachi",
  description: "Change management, employer branding, internal communications. What I think, what I observe.",
};
      ...
      <section className="pt-40 pb-16 bg-[#26170c]">
        <div className="container-custom">
          <h1 className="font-display font-bold text-white leading-[0.88] tracking-[-0.04em]"
            ...
            Insights.<br />
            <span className="text-[#e9c176] italic font-light">On communications.</span>
          </h1>
          <p className="text-white/50 text-lg mt-8 max-w-md">
            Change management, employer branding, internal communications. What I think, what I observe.
          </p>
        </div>
      </section>
        ...
        <div className="container-custom">
          {posts.length === 0 ? (
            <div className="py-24 text-center">
              <p className="font-display font-bold text-[#d2c4bc] text-2xl">Articles coming soon.</p>
              <p className="text-[#81756e] mt-3 text-sm">Check back in a few days.</p>
            </div>
          ) : (
